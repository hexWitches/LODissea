...
rsq01_path = '/Users/martinauccheddu/Library/CloudStorage/OneDrive-AlmaMaterStudiorumUniversitàdiBologna/Information Visualization/LODissea/website/assets/js/RsQ01.js'
rsq03_path = '/Users/martinauccheddu/Library/CloudStorage/OneDrive-AlmaMaterStudiorumUniversitàdiBologna/Information Visualization/LODissea/website/assets/js/RsQ03.js'
output_path = '/Users/martinauccheddu/Library/CloudStorage/OneDrive-AlmaMaterStudiorumUniversitàdiBologna/Information Visualization/LODissea/website/assets/js/rq01.js'
index_path = '/Users/martinauccheddu/Library/CloudStorage/OneDrive-AlmaMaterStudiorumUniversitàdiBologna/Information Visualization/LODissea/website/index.html'

with open(rsq01_path, 'r') as f:
    r1 = f.read()

with open(rsq03_path, 'r') as f:
    r3 = f.read()

# Extract inner logic of buildChart from RsQ01
start_rq1 = r1.find('const root = am5.Root.new(containerId);')
end_rq1 = r1.find('} catch (err) {')
rq1_logic = r1[start_rq1:end_rq1].strip()

# Extract inner logic of buildChart from RsQ03
start_rq3 = r3.find('const root = am5.Root.new(containerId);')
end_rq3 = r3.find('} catch (err) {')
rq3_logic = r3[start_rq3:end_rq3].strip()
...
# Modify index.html to point to rq01.js and remove RsQ01.js, RsQ03.js
with open(index_path, 'r') as f:
    idx_content = f.read()

idx_content = idx_content.replace('<script src="assets/js/RsQ01.js"></script>', '<script src="assets/js/rq01.js"></script>')
idx_content = idx_content.replace('<script src="assets/js/RsQ03.js"></script>', '')

with open(index_path, 'w') as f:
    f.write(idx_content)

print("Merged JS files into rq01.js")
